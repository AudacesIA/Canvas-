...
(function () {
  ...
  const api = {
    ...
    notificacoes: () => request('GET', '/api/notificacoes'),
    resolverNotificacao: (id) => request('POST', `/api/notificacoes/${id}/resolver`),
    liberarIp: (id) => request('POST', `/api/notificacoes/${id}/liberar-ip`),
